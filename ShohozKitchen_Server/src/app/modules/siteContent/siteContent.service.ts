        ...
        if (!content) {
            content = await SiteContent.create({
                ...
                seo: {
                    ...
                    description: 'Shop the latest products with amazing deals at Shohoz Kitchen. Premium quality products at best prices.',
                    keywords: 'shohoz kitchen, shohozkitchen, ecommerce, online shopping, best deals, products, shop',
                },
                announcement: {
                    message: '',
                    bgColor: '#E4525C',
