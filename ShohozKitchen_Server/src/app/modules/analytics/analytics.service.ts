...
// Package status buckets reused across summaries.
const PROCESS_STATUSES = ['pending', 'confirmed', 'processing'];
const SHIPPING_STATUSES = ['shipped', 'on_the_way', 'out_for_delivery', 'delivery_attempt'];
    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            doc.font('Helvetica-Oblique').fontSize(9).fillColor('#888888').text(
                'Shohoz Kitchen Admin · Internal analytics report',
                left,
                doc.page.height - 50,
