...
const userSchema = new Schema<IUser, UserModel, IUserMethods>(
    {
        ...
        // ── Loyalty (set by admin on the Customers page) ──
        loyaltyPoints: { type: Number, default: 0, min: 0 },
        defaultDiscount: { type: Number, default: 0, min: 0, max: 100 }, // percent
...
// ── Indexes ──────────────────────────────────────
// email is already indexed by `unique: true` on the field.
